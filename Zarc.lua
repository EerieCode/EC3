...
function c100912039.initial_effect(c)
    c:EnableReviveLimit()
    aux.AddFusionProcFunMulti(c,false,{c100912039.fusfilter1,c100912039.fusfilter2,c100912039.fusfilter3,c100912039.fusfilter4})
...
function c100912039.check_fusion_material_48144509(g,chkf)
    ...
    local funs={c100912039.fusfilter1,c100912039.fusfilter2,c100912039.fusfilter3,c100912039.fusfilter4}
    local groups={}
    for i=1,4 do
...
function c100912039.select_fusion_material_48144509(tp,g,chkf)
    ...
    local funs={c100912039.fusfilter1,c100912039.fusfilter2,c100912039.fusfilter3,c100912039.fusfilter4}
    for i=1,4 do
        local mg2=mg:Filter(Auxiliary.FConditionFilterMultiSelect,nil,funs,4,mg,sg)
