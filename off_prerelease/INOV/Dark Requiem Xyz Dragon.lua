...
function c7349.initial_effect(c)
  ...
  e2:SetOpereation(c7349.negop)
  c:RegisterEffect(e2)
end

function c7349.con(e,tp,eg,ep,ev,re,r,rp)
  return e:GetHandler():IsExists(Card.IsCode,1,nil,16195942)
end
...
function c7349.negcon(e,tp,eg,ep,ev,re,r,rp)
  return c7349.con(e,tp,eg,ep,ev,re,r,rp) and ep~=tp and re:IsActiveType(TYPE_MONSTER) and Duel.IsChainNegatable(ev)
end
...
function c7349.negop(e,tp,eg,ep,ev,re,r,rp)
  Duel.NegateActivation(ev)
	...
	local g=Duel.GetMatchingCount(c7349.negfil,tp,LOCATION_GRAVE,0,nil,e,tp)
