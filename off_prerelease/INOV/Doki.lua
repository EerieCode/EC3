...
function c7381.fil(c,e,tp,dc)
    return c:IsRace(RACE_ROCK) and c:IsOriginalLevel(dc:GetOriginalLevel()) and c:IsOriginalAttribute(dc:GetOriginalAttribute()) and (c:IsCanBeSpecialSummoned(e,0,tp,false,false) or c:IsCanBeSpecialSummoned(e,0,tp,false,false,POS_FACEDOWN))
end
