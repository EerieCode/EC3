...
function c6153.initial_effect(c)
	...
	e4:SetCondition(c6153.spcon)
	e4:SetOperation(c6153.spop)
	c:RegisterEffect(e4)
end
...
function c6153.synlimit(e,c)
	...
	return not (c:IsAttribute(ATTRIBUTE_DARK) and c:IsRace(RACE_DRAGON+RACE_MACHINE))
end

function c6153.spcon(e,tp,eg,ep,ev,re,r,rp)
	return e:GetHandler():IsPreviousLocation(LOCATION_EXTRA)
end
function c6153.spop(e,tp,eg,ep,ev,re,r,rp)
	...
	e1:SetCondition(c6153.rmcon)
	e1:SetReset(RESET_EVENT+0x1fe0000)
	c:RegisterEffect(e1)
end
function c6153.rmcon(e,tp,eg,ep,ev,re,r,rp)
	return e:GetHandler():IsReason(REASON_MATERIAL) and e:GetHandler():IsReason(REASON_SYNCHRO)
end
